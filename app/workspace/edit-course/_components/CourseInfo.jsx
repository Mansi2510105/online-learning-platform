import { Clock, TrendingUp, Book, Settings, Loader2, PlayCircle } from 'lucide-react';
...
function CourseInfo({ course, viewCourse }) {
    ...
    return (
        <div className='md:flex gap=5 justify-between p-5 rounded-2xl shadow-sm'>
            ...
            {/* <Image src={course?.bannerImageUrl} alt={'bnner Image'} width={400} height={400} className='w-full mt-5 md:mt-0 object-cover aspect-auto h-[240px] rounded-2xl'/> */}
            <Image
  src={
